...
export default function Hero() {
  return (
    <section id="home" className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      {/* Particle Dots (CSS background pattern) */}
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-brand-accent">Shipping & Logistics</span> Solutions
          </motion.h1>
          ...
          >
            <a 
              ...
              className="bg-brand-primary hover:bg-green-800 text-white px-8 py-4 rounded-full font-bold text-lg text-center transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 block"
            >
              Inquire Now
            </a>
            <a 
      ...
      >
        <div className="bg-brand-accent p-3 rounded-lg text-black shrink-0">
          <Ship size={24} />
        </div>
        <div>
          <h4 className="text-white font-bold text-lg mb-1">Sea Freight</h4>
          <p className="text-gray-300 text-sm">Efficient and affordable ocean shipping solutions.</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div>
          ...
          <p className="text-gray-300 text-sm">Fast international air cargo solutions.</p>
        </div>
      </motion.div>
